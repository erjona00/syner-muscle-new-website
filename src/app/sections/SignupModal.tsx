...
import { ArrowRight, LockKeyhole, Mail, ShieldCheck, User, X } from "lucide-react";
...
export default function SignupModal({ selectedPlan, onClose }: SignupModalProps) {
  const description = selectedPlan
    ? `Create your account to start the ${selectedPlan.name} plan and continue checkout.`
    : "Create your SynerMuscle account and start your fitness journey.";
  const securityMessage = selectedPlan
    ? "Secure checkout starts after signup"
    : "Create your profile and continue in seconds.";
        ...
        <div className="relative p-6 sm:p-7">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h3 id="signup-title" className="text-2xl font-semibold tracking-normal text-foreground">
                Create your account
              </h3>
