    ...
    >
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full rounded-xl border border-border bg-black/40 px-9 py-3 text-sm outline-none ring-0 transition focus:border-accent/60 focus:shadow-glow placeholder:text-muted/70"
      ...
      <button
        type="submit"
        className="rounded-xl bg-gradient-to-r from-accent to-highlight px-4 py-3 text-sm font-medium text-black transition active:scale-[.98] hover:opacity-95"
      >
        Join early access
      </button>
    </motion.form>
      ...
      <Container>
        <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border border-border bg-card/70 p-5 sm:flex-row sm:p-6">
          ...
          <div className="flex items-center gap-5 text-sm">
            <a href="#" className="hover:text-foreground/90 text-muted transition">Privacy</a>
            <a href="#" className="hover:text-foreground/90 text-muted transition">Contact</a>
          </div>
        </div>
      </Container>
    </footer>
